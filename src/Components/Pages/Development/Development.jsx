...
const Development = () => {
  ...
  return (
    <div className="relative flex flex-col items-center text-center bg-black text-white overflow-hidden pt-12">
      ...
      {/* headings */}
      <h2
        className="mt-6 text-4xl md:text-5xl bg-gradient-to-b from-white to-gray-500 bg-clip-text text-transparent font-semibold"
        data-aos="fade-up"
        data-aos-delay="100"
      >
      ...
      <p
        className="z-10 mt-4 max-w-xl text-xl text-gray-400 px-6"
        data-aos="fade-up"
        data-aos-delay="200"
      >
